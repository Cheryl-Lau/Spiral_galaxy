...
def init_grid(ell_x_coord, ell_y_coord, model_galactic_radius, ax1):
    ...
    grid_min = -model_galactic_radius *grid_size
    grid_max = model_galactic_radius  *grid_size 
...
rc_filename = 'rotation_curve_kep.dat'  # R:kpc, v:km/s
...
# Size of grid as a multiple of galactic radius (must cover entire disc)
grid_size = 1.1 
